...
\section{Extra Credit}
	...
	\subsection{Recursive find component}
		...
		\begin{figure}[p]
			\centering
			\subfloat[Original]{\label{1}\includegraphics[width=0.45\textwidth]{./images/hubble1.png}}
			\subfloat[Regions counted]{\label{2}\includegraphics[width=0.45\textwidth]{./images/hub1.png}}
			\caption{Hubble 1}
		\end{figure}
		\begin{figure}[p]
			\centering
			\subfloat[Original]{\label{3}\includegraphics[width=0.45\textwidth]{./images/hubble2.png}}
			\subfloat[Regions counted]{\label{4}\includegraphics[width=0.45\textwidth]{./images/hub2.png}}
			\caption{Hubble 2}
		\end{figure}
		\begin{figure}[p]
			\centering
			\subfloat[Original]{\label{5}\includegraphics[width=0.45\textwidth]{./images/hubble6.png}}
			\subfloat[Regions counted]{\label{6}\includegraphics[width=0.45\textwidth]{./images/hub6.png}}
			\caption{Hubble 6}
		\end{figure}
\end{document}
